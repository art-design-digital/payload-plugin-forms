...
import { defaultPluginOptions, Locale, PluginOptionsTypes, Widths } from '../types'
...
export const Forms = (userPluginOptions: PluginOptionsTypes) => {
        ...
        tabs: [
          {
            ...
            fields: [
                ...
                fields: [
                  {
                    ...
                    name: 'subject',
                    label:
                      translations.fields.generalTab.fields.senderReceiverGroup.fields.subject
                        .label,
                    required: true,
                    admin: {
                      description:
              ...
              },
              {
                ...
                admin: {
                  description:
                    translations.fields.generalTab.fields.feedbackGroup.admin.description,
                },
                fields: [
                  {
                    type: 'text',
            ...
            fields: [
              {
                ...
                admin: {
                  description:
                    translations.fields.formFieldsTab.fields.formFields.admin.description,
                  initCollapsed: true,
                  components: {
                    RowLabel: ({ data }: any) => {
                ...
                fields: [
                  {
                    ...
                    name: 'required',
                    label:
                      translations.fields.formFieldsTab.fields.formFields.fields.required.label,
                  },
                  {
                    type: 'select',
                    name: 'fieldType',
                    required: true,
                    label:
                      translations.fields.formFieldsTab.fields.formFields.fields.fieldType.label,
                    defaultValue: 'text',
                    options: [
                      {
                        label:
                          translations.fields.formFieldsTab.fields.formFields.fields.fieldType
                            .options.text.label,
                        value: 'text',
                      },
                      {
                    ...
                    fields: [
                      {
                        ...
                        name: 'label',
                        label:
                          translations.fields.formFieldsTab.fields.formFields.fields.row.label
                            .label,
                        required: true,
                        admin: {
                          description:
                      ...
                      },
                      {
                        ...
                        admin: {
                          description:
                            translations.fields.formFieldsTab.fields.formFields.fields.row
                    ...
                    fields: [
                      {
                        ...
                        admin: {
                          description:
                            translations.fields.formFieldsTab.fields.formFields.fields.options
                              .fields.value.admin.description,
                        },
                        localized: true,
                      },
                    ],
                  },
                  {
                    ...
                    admin: {
                      description:
                        translations.fields.formFieldsTab.fields.formFields.fields.emptyDefault
                          .admin.description,
                      condition: (_, siblingData) => {
                        return ['dropdown'].includes(siblingData.fieldType)
                      },
                    ...
                    fields: [
                      {
                        ...
                        admin: {
                          description:
                            translations.fields.formFieldsTab.fields.formFields.fields
                              .placeholderRow.fields.placeholder.admin.description,
                          condition: (_, siblingData) => {
                      ...
                      },
                      {
                        ...
                        admin: {
                          description:
                            translations.fields.formFieldsTab.fields.formFields.fields
                              .placeholderRow.fields.default.admin.description,
                          condition: (_, siblingData) => {
                            return (
                    ...
                    fields: [
                      {
                        ...
                        name: 'minLength',
                        label:
                          translations.fields.formFieldsTab.fields.formFields.fields.lengthRow
                            .fields.minLength.label,
                        admin: {
                          width: '50%',
                          condition: (_, siblingData) => {
